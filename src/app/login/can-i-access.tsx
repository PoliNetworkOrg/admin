      ...
      <div className="grid grid-rows-3 py-2 max-lg:space-y-4 lg:flex lg:space-x-4">
        ...
        <Card className="flex-1 p-4">
          <div className="grid h-full w-full grid-cols-1 grid-rows-[2fr_1fr] gap-y-4">
            ...
            />
            <div className="text-center">
              <p className="text-primary text-xl font-bold dark:text-white">3. Use the dashboard</p>
              <p className="text-muted-foreground text-sm">
                If your role is not recognized, <br /> be patient until the IT team fixes it!
              </p>
            </div>
          </div>
        </Card>
